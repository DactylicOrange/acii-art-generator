...
R = 350
MAP_WIDTH = 149 # enter 1 less (for example enter 139 if you have 140)
MAP_HEIGHT = 40 # enter 1 less (for example enter 34 if you have 35)

pg.init()

my_font = pg.font.SysFont('arial', 18)

with open('PATH TO TEXT FILE', 'r') as file:
...
class Projection:
    def __init__(self, width, height):
        ...
        pg.display.set_caption('ASCII 3D MOON')
        self.surfaces = {}
